...
| -------------- | ------------------------------------------------------------ | ------------ | ----------- |
| **MS1**        | <!-- *Project Proposals, Team formation -*  Students submit project proposals and form teams. Staff reviews proposals and return feedback and project approvals by TBD. --><br /><br /> Form teams and submit a project proposal covering problem definition, data sources, scope, and a preliminary app design. Ground your technical choices in what's been covered: virtual environments, containers, and LLM tools including RAGs and agents. | **9/29** | **4**       |
| **MS2**        | <!-- *MLOps Infrastructure & Advanced Training Workflows -* Build atomic containers, implement versioned data pipelines, and develop scalable computing solutions for efficient deployment.Scalable and Modular Computing Infrastructure – Enhance training workflows with TensorFlow, experiment tracking, multi-GPU support, and serverless training environments. --><br /><br /> Build a containerized end-to-end pipeline. Teams should have data versioning in place, LLM fine-tuning underway (or vision model experiments documented), a basic CI setup with unit tests, and a refined app design. | **10/20** | **10**      |
| **MS3**        | <!-- *Midterm Presentation (video)* - Present your AI application as an investor pitch, covering the problem, value proposition, scalability, future development, and technical details, with slides and code submitted via GitHub. --><br /><br /> Integrate your model into a running system. Teams should have advanced training workflows (experiment tracking, serverless training on Vertex AI), a serverless deployment (Cloud Functions or Cloud Run), production monitoring, a working API, and a functional frontend. | **11/12** | **18**      |
